...
def load(filename):
    ...
    # FIXME: This is horrible and unsafe. No need to serialize the
    #        class, arguably all you'd need is a structured data tree
    #        encountaining all the values. Those can be read back to
    #        python types and then associated. I will fix this. -D.
